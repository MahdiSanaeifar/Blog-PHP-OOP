    ...
    <section class="col-12">
        ...
        <?php if ($comment['status'] == 'seen') { ?>
            <a role="button" class="btn btn-sm btn-success text-white"
               href="http://localhost/admin-panel/comment/approved/<?php echo $comment['id']; ?>">click to approved</a>
        <?php } else {?>
            <a role="button" class="btn btn-sm btn-warning text-white"
               href="http://localhost/admin-panel/comment/approved/<?php echo $comment['id']; ?>">click to not approved</a>
        <?php } ?>
    </section>
</section>
