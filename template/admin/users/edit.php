            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            <form role="form" method="post" action="https://domain.ir/user/update/<?php echo $id ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="membership" name="membership" class="form-control" value="<?= $user['membership']; ?>"
                                           placeholder="کد عضویت  ..." readonly>
                                </div>
                                <div class="form-group">
                                    <label>کدملی</label>
